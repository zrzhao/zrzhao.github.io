...
Now that the list is in the required format, it can be easily converted into a dictionary with `dict()`.  For more examples, see [documentation](https://docs.python.org/3/tutorial/datastructures.html). 
